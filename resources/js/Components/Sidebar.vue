...
<template>
    <aside id="default-sidebar" class="w-2/5 p-12  h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar">
        <div class="h-full p-10 overflow-y-auto bg-white rounded-xl dark:bg-gray-800">
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <div @click="$emit('input', 'profileOverview')"
                         class="flex items-center p-3 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
