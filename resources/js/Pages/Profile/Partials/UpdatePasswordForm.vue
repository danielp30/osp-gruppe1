    ...
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Hier können Sie ihr Passwort ändern. Bitte geben Sie zunächst ihr aktuelles Passwort ein um danach ein neues vergeben zu können.
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password_confirmation" value="Neues Passwort wiederholen" />
